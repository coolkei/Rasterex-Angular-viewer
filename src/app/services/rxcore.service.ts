...
export class RxCoreService {
  ...
  _guiShouldPaste: BehaviorSubject<any> = new BehaviorSubject<any>(false);
  shouldPaste$: Observable<any> = this._guiShouldPaste.asObservable();
  public setShouldPaste(value: boolean): void {
    this._guiShouldPaste.next(value)
  }
