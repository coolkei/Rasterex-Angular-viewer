...
export class InsertModalComponent implements OnInit {
    ...
    selectedPresets = this.presetsOptions[0];
    selectedUnits = this.unitsOptions[0];
    ...
    close() {
        ...
        this.selectedPresets = this.presetsOptions[0];
        this.selectedUnits = this.unitsOptions[0];
        ...
        this.currentPage = 0;
        this.pageRangeStr = "";
        this.checkedPageRangeStr = "";
        this.numberPages = 1;

        this.customWidth = 8.5;
        this.customHeight = 11;
    ...
    addPages() {
        ...
        switch (this.selectedPresets.value) {
            case '1':
                width = 8.27 * DPI.x;
                height = 11.69 * DPI.y;
                break;
            ...
            case '5':
                ...
                break;
            default:
                switch(this.selectedUnits.value) {
                    case '3':
    ...
    importPages() {
        ...
        this.loadingStatus = 'LOADING';
        RXCore.importPages(this.file, newPageRange, checkedPages, this.visible === 'REPLACE', this.selectedCount(), width, height).then(() => {
            this.close()
        }).catch(() => {
            this.loadingStatus = 'NONE';
        })
